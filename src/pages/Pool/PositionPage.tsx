            ...
            <AutoColumn gap="sm" style={{ width: '100%', height: '100%' }}>
		      ...
		      {fiatValueOfLiquidity?.greaterThan(new Fraction(1, 100)) ? (
                  ...
                  <LightCard padding="12px 16px">
                    <AutoColumn gap="md">
                      <RowBetween>
                        <div id="token0"><LinkedCurrency chainId={chainId} currency={currencyQuote} /></div>
                        <RowFixed>
			  <div id="liquidity-token0">
                          <TYPE.main>
				  ...
				  <Trans>{inverted ? ratio : 100 - ratio}%</Trans>
                      ...
                      <RowBetween>
                        <div id="token1"><LinkedCurrency chainId={chainId} currency={currencyBase} /></div>
                        <RowFixed>
			  <div id="liquidity-token1">
                          <TYPE.main>
                      ...
                      <AutoColumn gap="md">
                        ...
                        {fiatValueOfFees?.greaterThan(new Fraction(1, 100)) ? (
                          <TYPE.largeHeader color={theme.green1} fontSize="36px" fontWeight={500}>
                            <div id="unclaimed-fees-total"><Trans>${fiatValueOfFees.toFixed(2, { groupSeparator: ',' })}</Trans></div>
                          </TYPE.largeHeader>
                        ) : (
                          <TYPE.largeHeader color={theme.text1} fontSize="36px" fontWeight={500}>
                            <div id="unclaimed-fees-total"><Trans>$-</Trans></div>
                          </TYPE.largeHeader>
                        )}
                      </AutoColumn>
                  ...
                  <LightCard padding="12px 16px">
                    <AutoColumn gap="md">
                      <RowBetween>
                        ...
                        <RowFixed>
                          <div id="unclaimed-fees-token0"><TYPE.main>{feeValueUpper ? formatCurrencyAmount(feeValueUpper, 4) : '-'}</TYPE.main></div>
                        </RowFixed>
                      </RowBetween>
                      <RowBetween>
                        <RowFixed>
                        ...
                        <RowFixed>
                          <div id="unclaimed-fees-token1"><TYPE.main>{feeValueLower ? formatCurrencyAmount(feeValueLower, 4) : '-'}</TYPE.main></div>
                        </RowFixed>
                      </RowBetween>
                    </AutoColumn>
                  </LightCard>
            ...
            <AutoColumn gap="md">
              <RowBetween>
                <RowFixed>
                  ...
                  <HideExtraSmall>
                    <>
                      <div id="in-range"><RangeBadge removed={removed} inRange={inRange} /></div>
              ...
              <RowBetween>
                <LightCard padding="12px" width="100%">
                  <AutoColumn gap="8px" justify="center">
                    ...
                    <TYPE.mediumHeader textAlign="center">
                      <div id="min-price">{formatTickPrice(priceLower, tickAtLimit, Bound.LOWER)}</div>
                    </TYPE.mediumHeader>
                    <ExtentsText>
                      {' '}
                      <Trans>
                ...
                <LightCard padding="12px" width="100%">
                  <AutoColumn gap="8px" justify="center">
                    ...
                    <TYPE.mediumHeader textAlign="center">
                      <div id="max-price">{formatTickPrice(priceUpper, tickAtLimit, Bound.UPPER)}</div>
                    </TYPE.mediumHeader>
                    <ExtentsText>
                      {' '}
                      <Trans>
